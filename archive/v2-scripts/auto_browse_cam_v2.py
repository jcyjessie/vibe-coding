#!/usr/bin/env python3
"""
CAM Browser Capture - V2 (Kintsugi Style)

Uses storageState instead of persistent context.
More reliable and doesn't conflict with existing Chrome instances.

Usage:
    python auto_browse_cam_v2.py --url <cam-url> --feature-name <name> --auth-file .auth/state.json
"""
...
class CAMCaptureV2:
    ...
    def automatic_capture(self, target_url: str):
        ...
        print("\n" + "="*60)
        print("AUTOMATIC CAPTURE MODE - V2 (KINTSUGI STYLE)")
        print("="*60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Capture CAM feature using storageState (Kintsugi style)",
