---
name: cam-browser-capture
description: Automate screenshot capture via browser automation for CAM user guide documentation
version: 1.0.0
---

# CAM Browser Capture

This sub-skill automates screenshot capture via browser automation to document CAM workflows.
...
The browser automation scripts are located in:
`/Users/jessiecao/.claude/skills/cam-user-guide-writer/scripts/`

Files include:
- `auto_browse_cam.py` - Automatic capture script
- `browse_cam.py` - Interactive capture script
- Additional helper scripts for specific workflows
